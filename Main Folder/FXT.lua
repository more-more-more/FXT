...
-- Radar
Visuals_Radar:AddToggle({text = "Enabled", tooltip = "Displays a radar UI", flag = "Visuals_Radar_Enabled", state = false, risky = false, callback = function(v) end})
    :AddBind({text = "Keybind", tooltip = "Toggles radar", bind = Enum.KeyCode.K, mode = "toggle", flag = "Visuals_Radar_Keybind", callback = function(v) end})
...
Visuals_Radar:AddSlider({text = "Size", tooltip = "Size of the radar", flag = "Visuals_Radar_Size", min = 50, max = 300, increment = 1, value = 150, callback = function(v) end})
Visuals_Radar:AddSlider({text = "Range", tooltip = "Radar detection range", flag = "Visuals_Radar_Range", min = 100, max = 2000, increment = 50, value = 500, callback = function(v) end})
...
if not ok then warn("GUI Build Failed:", err) end
